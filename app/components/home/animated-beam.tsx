...
/** Capa de fondo: usar dentro de un contenedor `relative` (p. ej. `min-h-screen`). */
export default function BackgroundBeamsDemo({ className }: BackgroundBeamsDemoProps) {
  return (
    <div
      className={cn(
        "pointer-events-none absolute inset-0 z-0 overflow-hidden bg-neutral-950",
        className
      )}
    >
      <BackgroundBeams />
